...
import com.zokscore.mobile.patternrecognition.recognition.ClassifierTrainData;
...
public class CollectActivity extends AppCompatActivity implements ServiceListener {
    ...
    protected void onStart() {
        ...
        System.out.println("onStart "+this.getClass());
    }
    ...
    protected void onStop() {
        ...
        System.out.println("onStop "+this.getClass());
    }
