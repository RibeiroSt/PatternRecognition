...
import com.zokscore.mobile.patternrecognition.ServiceListener;
import com.zokscore.mobile.patternrecognition.recognition.FFT;
import com.zokscore.mobile.patternrecognition.sensors.SensorData;
...
public abstract class FFTAccGyroscope64 extends ActivityClassifier {
    ...
    public final String BROADCAST_ACTIVITY = "com.zokscore.mobile.patternrecognition.BROADCAST_ACTIVITY";
    ...
    private boolean broadcastActivity;

    public FFTAccGyroscope64(Context context, boolean broadcastActivity) throws Exception {
        super(context);
            ...
            public void run() {
                try {
                    ...
                    if( classifier!=null ) {
                        ...
                        String act = singleInstance.classAttribute().value((int) result);
                        res += "Activity: " + act + "\n\n";
                        res += "Counter: " + (counter++) + "\n\n";
//                        res += "Stepdetector: " + data.getStepDetectorData() + "\n";
                        ...
                        if( broadcastActivity ) {
                            Intent in = new Intent(BROADCAST_ACTIVITY);
                            in.putExtra("activity", act);
                            contextInstance.sendBroadcast(in);
                        }
                    }
                } catch (Exception e) {
